...
# Builds the C++ host program that loads and runs the kernel
# Bygger C++-värdprogrammet som laddar och kör kärnan
hipcc -o runner host.cpp
...
Same as the parent MFMA course repository: Apache 2.0.
